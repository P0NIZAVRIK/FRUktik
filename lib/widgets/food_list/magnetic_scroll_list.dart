...
class MagneticScrollList<T> extends StatefulWidget {
  final List<T> items;
  final Widget Function(BuildContext context, T item, bool isFocused)
      itemBuilder;
...
class _MagneticScrollListState<T> extends State<MagneticScrollList<T>> {
  ...
  void _onScroll() {
    ...
    final centerOffset =
        offset + (viewportHeight / 2) - (widget.itemHeight / 2);
    final newFocusedIndex = (centerOffset / widget.itemHeight)
        .round()
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final scale =
            isFocused ? 1.05 : (1.0 - distance * 0.05).clamp(0.85, 1.0);
        final opacity =
            isFocused ? 1.0 : (1.0 - distance * 0.15).clamp(0.4, 1.0);
          ...
          child: AnimatedOpacity(
            ...
            child: Container(
              ...
              decoration: isFocused
                  ...
                  : null,
              child:
                  widget.itemBuilder(context, widget.items[index], isFocused),
            ),
          ),
        );
      },
