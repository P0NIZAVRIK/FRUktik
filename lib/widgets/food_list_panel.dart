...
// import '../models/food_item.dart'; // Unused
...
class _FoodListPanelState extends State<FoodListPanel> {
  ...
  Widget build(BuildContext context) {
    // Sync controller with provider if changed externally (e.g. from Camera)
    ...
    return Container(
      ...
      decoration: const BoxDecoration( // ... existing decoration ...
